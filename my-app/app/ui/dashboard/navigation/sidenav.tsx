  ...
  return (
    <div className='sidebar'>
      ...
      <div className="subscribed-list">
        <h3>Subscribed</h3>
        <div className="side-link">
          <Image  width={25} src={jack} alt=""/> <p>PewDiePie</p>
        </div>
        <div className="side-link">
          <Image width={25} src={simon} alt=""/> <p>MrBeast</p>
        </div>
        <div className="side-link">
          <Image width={25} src={tom} alt=""/> <p>Justin Bieber</p>
        </div>
        <div className="side-link">
          <Image width={25} src={megan} alt=""/> <p>5-Minute Crafts</p>
        </div>
        <div className="side-link">
          <Image width={25} src={cameron} alt=""/> <p>Nas Daily</p>
        </div>
      </div>
      {/* <NavLinks /> */}
    </div>
